...
namespace CamuseHome
{
    public class Sqlite
    {
        ...
        {
            return new SQLiteConnection("Data Source=" + new System.IO.DirectoryInfo(System.Environment.CurrentDirectory).FullName + "\\Database\\CamuseHome.sqlite;Pooling=true;FailIfMissing=false;Version=3;");
        }
